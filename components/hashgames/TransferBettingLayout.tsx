...
const TransferBettingLayout: React.FC = () => {
  ...
  return (
    <>
      <div
        className={cn(
          'w-full max-w-6xl lg:px-0 p-2 mx-auto',
        ...
        >
          <div className="flex bg-[#72707038] rounded-lg p-1">
            ...
            <Link
              ...
              className={PAGE_BETTING_BUTTON_CLASSES}
            >
        ...
        <div className="bg-[#72707038] rounded-lg w-full p-1 hidden [@media(max-width:768px)]:flex">
          ...
          <Link
            ...
            className={cn(
              ...
              'text-white text-[14px] border-none flex items-center gap-2',
              'hover:bg-[rgba(255,255,255,0.08)]'
            )}
          >
            <img
