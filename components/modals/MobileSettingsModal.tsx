...
export default function MobileSettingsModal({
  ...
  const handleTabSelect = (tabName: string) => {
    console.log('Mobile Modal: Tab selected:', tabName)
    onTabSelect(tabName)
    onClose()
  }
  ...
  return (
    <ModalContainer
      ...
      size="md"
      position="responsive" // Use responsive position: bottom on mobile, center on desktop
      showHeader={true}
      showCloseButton={true}
      className="mobile-optimized-modal"
      contentClassName="mobile-settings-content"
    >
        ...
        {settingsTabs.map(tab => {
          ...
          return (
            <div
              ...
              className={`
                w-full flex items-center gap-4 px-4 py-3 rounded-lg font-montserrat text-sm font-bold transition-all duration-200 hover:bg-white-4/60
